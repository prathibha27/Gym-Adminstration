...
<html lang="en">
 ...
 <center>   
     ...
     $result=mysqli_query($db, "SELECT `first`,`last`,`days`,`email`,`age`,`gender`, `dob`,`contact`
     FROM `member_info`,`attendance`
     WHERE `tuser` = '$username' and `muser` = `username` ") or die("Error: " . mysqli_error($db));
       echo "<table class='table table-bordered' > ";
       echo "<tr>";
